...
import {
    AddSuccessAction,
    LoadSingleSuccessAction, LoadSuccessAction, UpdateSuccessAction
...
export function reducer(state = initialState, action: aa.Actions): State {
    switch (action.type) {
        ...
        case aa.ActionTypes.UPDATE_SUCCESS: {
            const updateSuccessAction = action as UpdateSuccessAction;
            const article = updateSuccessAction.payload;
            return Object.assign({}, state, {
                entities: Object.assign({}, state.entities, {
                    [article.Id]: article
                })
